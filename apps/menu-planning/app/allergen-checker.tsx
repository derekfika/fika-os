...
export default function AllergenChecker() {
  ...
  const complete = (entry: typeof entries[number]) => CANONICAL_ALLERGEN_COLUMNS.every(([key]) => Object.prototype.hasOwnProperty.call(entry.allergens, key) && (entry.allergens[key] === "clear" || entry.allergens[key] === "contains" || entry.allergens[key] === "may_contain"));
