...
async function writeReviews(reviews: CandidateReview[]) { await mkdir(path.dirname(filePath), { recursive: true }); await writeFile(filePath, JSON.stringify({ version: 1, reviews }, null, 2) + "\n", "utf8"); }
