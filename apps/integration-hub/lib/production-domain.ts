...
import { productionOrderRequiresFulfilment } from "@fika/contracts/fulfilment-requirement";
import { hospitalityMenuProductionRouting } from "./connections-service";

export const PRODUCTION_SCHEMA_VERSION = "0.1.0";
import type { ProductionAuditEvent, ProductionCategory, ProductionDestinationAddress, ProductionException, ProductionLine, ProductionOrigin, ProductionOrder, ProductionRequirement, ProductionStatus, ProductionWorkstream } from "@fika/contracts/production";
export type { ProductionAuditEvent, ProductionCategory, ProductionDestinationAddress, ProductionException, ProductionLine, ProductionOrigin, ProductionOrder, ProductionRequirement, ProductionStatus, ProductionWorkstream } from "@fika/contracts/production";
