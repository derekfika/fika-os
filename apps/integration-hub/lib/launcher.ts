...
const defaults: Record<string, string> = { "cpu-production": "http://localhost:3400", logistics: "http://localhost:3900", "menu-planning": "http://localhost:3500", "hospitality-booking": "http://localhost:3300/workspace", "delivered-in": "http://localhost:3800", "ad-hoc-production": "http://localhost:4000" };
