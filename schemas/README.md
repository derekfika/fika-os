...
- [Pack 1](pack-1/README.md) contains foundational identity and Operational Location Draft schemas.
...
- [Pack 3](pack-3/) contains Service Domain Draft schemas.
- [Pack 4](pack-4/) contains Booking Domain Draft schemas.
- [Pack 5](pack-5/README.md) contains the Event Domain Draft schema and fixtures.
