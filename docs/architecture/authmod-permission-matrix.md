...
| Menu Planning publication/withdrawal | yes |  |  |  | yes |  | explicit publication/site audience scope; normal site access still applies to the workflow | Separate menu.publish; Hub Admin does not imply it. |
