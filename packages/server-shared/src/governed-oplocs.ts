...
/** Return the current canonical ID for a known historical ID. Unknown IDs stay explicit. */
...
/** Compare IDs across the controlled historical-ID compatibility boundary. */
