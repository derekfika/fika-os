...
const MENU_SCHEMA = Object.freeze([
  menuItem_("bloom_filter_coffee", "Drinks", "Bloom Filter Coffee", "Ethical filter coffee, served per person.", "Per person", 3, 1, null, 3, [], 10),
  ...
  menuItem_("large_pastries", "Breakfast", "Freshly Baked Large Pastries", "Six plain croissants and six raspberry croissants.", "Box of 12 pastries", 42, 1, null, 3, [], 140),
