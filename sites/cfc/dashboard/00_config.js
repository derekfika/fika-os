const CONFIG = {
  ...
  QUOTE_TEMPLATE_DOC_ID: "REPLACE_WITH_CFC_QUOTE_TEMPLATE_DOC_ID",
  QUOTE_ROOT_FOLDER_NAME: "CFC Hospitality",
  SHEET_NAME: "Dashboard Data",

  PRINTER_EMAIL: "mvt5149ww1d8q0@print.epsonconnect.com",

  DRIVE: {
    ROOT_FOLDER_NAME: "CFC Hospitality"
  },
  ...
  APP_NAME: "CFC Hospitality Dashboard",
  LOCATION_NAME: "CFC",
  LOCATION_SHORT_CODE: "CFC",
  ...
  COLOUR_BACKGROUND: "#EEF8FB",
  COLOUR_SURFACE: "#FFFFFF",
  COLOUR_SURFACE_ALT: "#E4F1F5",
  COLOUR_TEXT: "#07506F",
  COLOUR_TEXT_MUTED: "#4D7890",
  COLOUR_BORDER: "#C7DFE8",
  COLOUR_PRIMARY: "#176F8E",
  COLOUR_SECONDARY: "#063F62",
  COLOUR_SUCCESS: "#2F8068",
  COLOUR_WARNING: "#A7792E",
  COLOUR_DANGER: "#9B4444",
  COLOUR_INFO: "#2389A5",
...
function getSettingSchema_() {
  return [
    ...
    },
    {
      ...
      access: "admin",
      fields: [
        { key: "PROCESSED_LABEL_NAME", label: "Processed Gmail label", type: "text", fallback: "CFC_HOSPITALITY_PROCESSED", notes: "Legacy setting. Duplicate checking now uses Message ID + Attachment Name." },
    ...
    },
    {
      ...
      access: "admin",
      fields: [
        { key: "ANGEL_COURT_LOGO_URL", label: "CFC logo URL", type: "url", fallback: CONFIG.ANGEL_COURT_LOGO_URL, notes: "Reserved for future branded quote/dashboard use." },
