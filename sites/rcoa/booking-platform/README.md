...
The application is a branded clone of the existing FIKA demo booking platform. It preserves the complete six-step flow, menu logic, browser draft saving, validation, pricing, dietary capture, direct dashboard write path, notification emails, feedback preview, and responsive behaviour.
...
- Internal booking and feedback emails are locked to `derek@fikacatering.com`; the client email is recorded with the booking but is not used as a notification recipient.
