const SITE_CONFIG = Object.freeze({
  siteId: "rcoa",
  siteName: "Royal College of Anaesthetists",
  address: "Royal College of Anaesthetists, Jubilee House",
  clientFacingName: "RCoA Hospitality",
  currency: "GBP",
  locale: "en-GB",
  timeZone: "Europe/London",
  bookingReferencePrefix: "RCOA",
  ...
  sheets: {
    bookingRequests: "RCoA Booking Requests",
    bookingLineItems: "RCoA Booking Line Items",
    menuItems: "Menu Items",
    settings: "RCoA Platform Settings"
  },
  rules: {
  ...
  branding: {
    eyebrow: "Royal College of Anaesthetists",
    heroTitle: "Hospitality, thoughtfully arranged.",
    heroBody: "Plan refreshments, working lunches and events at the College in one clear request.",
    fikaLogoSvg: "",
    fikaLogoUrl: "https://www.rcoa.ac.uk/themes/custom/rcoa_base/images/rcoa-logo-white.svg",
    fikaLogoAlt: "Royal College of Anaesthetists",
    fikaFallbackText: "RCoA",
    siteLogoSvg: "",
    siteLogoUrl: "",
    siteLogoAlt: "RCoA Hospitality",
