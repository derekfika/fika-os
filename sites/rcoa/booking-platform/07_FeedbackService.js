...
function sendDemoFeedbackRequest_(dashboardBooking) {
  try {
    ...
    const recipient = normaliseDemoFeedbackRecipient_(SITE_CONFIG.feedback.recipient);
...
function sendDemoFeedbackEmail_(booking, recipient, link) {
  const subject = "We'd love your feedback | RCoA Hospitality";
  const bookingDate = formatDemoFeedbackDate_(booking.eventDate);
  const body = [
    "Hi there,",
    "",
    "Thank you for choosing RCoA Hospitality.",
    "",
    ...
    "",
    "The RCoA Hospitality Team"
  ].join("\n");
  const html = [
    '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0;padding:0;background:#F4F1F7;width:100%">',
    ...
    '<tr><td style="background:#2C1951;color:#FFFFFF;padding:34px 38px 36px">',
    '<img src="https://www.rcoa.ac.uk/themes/custom/rcoa_base/images/rcoa-logo-white.svg" alt="Royal College of Anaesthetists" width="144" style="display:block;width:144px;max-width:144px;height:auto;margin:0 0 22px;border:0">',
    '<div style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;letter-spacing:1.8px;text-transform:uppercase;color:#FFFFFF;opacity:.82">RCoA Hospitality</div>',
    ...
    '<p style="font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.5;margin:0;color:#FFFFFF;opacity:.88">Help us make every College hospitality experience even better.</p>',
    '</td></tr>',
    '<tr><td style="padding:36px 38px 34px;background:#FFFFFF;color:#2C1951;font-family:Arial,Helvetica,sans-serif">',
    '<p style="font-size:15px;line-height:1.6;margin:0 0 18px;color:#2C1951">Hi there,</p>',
    '<p style="font-size:15px;line-height:1.6;margin:0 0 18px;color:#2C1951">Thank you for choosing RCoA Hospitality.</p>',
    '<p style="font-size:15px;line-height:1.6;margin:0 0 26px;color:#2C1951">We hope everything went perfectly with your recent booking. We&rsquo;d really appreciate hearing about your experience, and it only takes around 60 seconds.</p>',
    ...
    '<div style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;letter-spacing:1.4px;text-transform:uppercase;color:#2C1951;margin:0 0 14px">Your booking details</div>',
    ...
    '<tr><td align="center" bgcolor="#E7E0EF" style="border-radius:10px;background:#E7E0EF">',
    '<a href="' + escapeDemoFeedbackHtml_(link) + '" aria-label="Share your RCoA Hospitality experience" style="display:inline-block;min-width:220px;padding:16px 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:18px;font-weight:bold;color:#2C1951;text-decoration:none;border-radius:10px">Share your experience &rarr;</a>',
    '</td></tr>',
    '</table>',
    '<p style="font-size:15px;line-height:1.6;margin:0 0 4px;color:#2C1951">Thank you for helping us deliver exceptional hospitality.</p>',
    '<p style="font-size:15px;line-height:1.6;margin:0 0 24px;color:#2C1951;font-weight:bold">The RCoA Hospitality Team</p>',
    '<p style="font-size:12px;line-height:1.55;margin:0;color:#655D70">Your feedback goes directly to the hospitality team and helps us continuously improve our food, service and hospitality.</p>',
    '</td></tr>',
    '</table>',
    '</td></tr>',
    '</table>'
