...
function buildBookingNotificationHtml_(booking, eventType) {
  ...
  return [
    ...
    '<p style="margin:0 0 18px;color:#5F5A82;font-size:14px;line-height:1.5">Hi ' + escapeNotificationHtml_(booking.client.name) + ', thank you. Your hospitality booking request has been received. The requested menu items are included below.</p>',
    ...
    '<p style="font-size:12px;color:#6F67A8;margin:24px 0 0">This request is subject to confirmation. The hospitality team will contact you once it has been reviewed.</p>',
    '</div>',
    '</div>'
  ].join("");
}
